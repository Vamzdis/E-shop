...
#I cant thing of a scenario where we would need to specify balance when creating it so I'm not adding it to init method
    def __init__(self, id : int, name : str, email : str, password : str, block_until :datetime, created_on : datetime):
        super().__init__( id, created_on) #in the examples we did I remember mixed opinions if this should be kept on not so I'm keeping it just in case
        self.name = name
        self.email = email
